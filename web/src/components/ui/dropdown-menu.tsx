...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Separator ref={ref} className={cn("h-px my-1 bg-[#3c3c3c]", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Label ref={ref} className={cn("px-3 py-1 text-[11px] text-[#858585]", className)} {...props} />
))
